import { o as De, t as ye } from "../chunks/index.b0d75dac.js";
import {
    S as He,
    a as Je,
    I as V,
    ...
    P as qe,
    e as We,
} from "../chunks/singletons.d6bb87b5.js";
import { b as J } from "../chunks/paths.9179f118.js";
function Xe(t, o) {
    return t === "/" || o === "ignore"
        ? t
        : o === "never"
...
window.fetch = (t, o) => (
    (t instanceof Request
        ? t.method
        : (o == null ? void 0 : o.method) || "GET") !== "GET" &&
        ne.delete(Se(t)),
    fe(t, o)
);
const ne = new Map();
...
function Rt(t, o) {
    ...
    function Ae(e) {
        ...
        (n = Q[e]) == null ||
            n.forEach((r, a) => {
                var s, c;
                (c = (s = l[a]) == null ? void 0 : s.snapshot) == null ||
                    c.restore(r);
            });
    }
    function Ie() {
    ...
    async function Le(e) {
        return (
            (w = {
                ...
                promise: he(e).then(
                    (n) => (
                        n.type === "loaded" && n.state.error && (w = null), n
                    )
                ),
            }),
            w.promise
            ...
            return de({
                ...
                parent: async () => {
                    ...
                    for (let me = 0; me < L; me += 1)
                        Object.assign(
                            je,
                            (Te = await $[me]) == null ? void 0 : Te.data
                        );
                    return je;
                },
                server_data_node: pe(
    ...
    async function ce({
        ...
        if (b.type === "redirect")
            if (a.length > 10 || a.includes(e.pathname))
                ...
                return (
                    re(new URL(b.location, e).href, {}, [...a, e.pathname], m),
                    !1
                );
        else
        ...
        if (
            ...
            (C = b.props.page) != null &&
                ...
                (e.pathname =
                    (E = b.props.page) == null ? void 0 : E.url.pathname),
            s)
        ) {
            const L = s.replaceState ? 0 : 1;
            if (
                ((s.state[V] = j += L),
                history[s.replaceState ? "replaceState" : "pushState"](
                    s.state,
                    "",
                    e
                ),
        ...
        _start_router: () => {
            ...
            (history.scrollRestoration = "manual"),
                ...
                f.addEventListener("click", (n) => {
                    ...
                    if (R !== void 0 && y === location.href.split("#")[0]) {
                        if (p.url.hash === a.hash) {
                            n.preventDefault(),
                                (A = r.ownerDocument.getElementById(R)) ==
                                    null || A.scrollIntoView();
                            return;
                        }
                        if (
                            ((z = !0),
                    ...
                    ce({
                        ...
                        details: {
                            state: {},
                            replaceState:
                                m.replace_state ?? a.href === location.href,
                        },
                ...
                f.addEventListener("submit", (n) => {
                    ...
                    const r = HTMLFormElement.prototype.cloneNode.call(
                            n.target
                        ),
                        a = n.submitter;
                    if (
                        ((a == null ? void 0 : a.formMethod) || r.method) !==
                        "get"
                    )
                        return;
                    const c = new URL(
                    ...
                    O &&
                        A.append(
                            O,
                            (a == null ? void 0 : a.getAttribute("value")) ?? ""
                        ),
